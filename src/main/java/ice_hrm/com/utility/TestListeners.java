...
//		  log=extentReports.createTest(methodName);
	...
	public void onTestFailedButWithinSuccessPercentage(ITestResult result) {
		System.out.println("This is onTestFaiedButwithinSuccessPercentage of ItestResult from TestListeners");
	}

	@Override
	public void onTestFailedWithTimeout(ITestResult result) {
	   System.out.println("This is onTestFailedWithTimeout of ITestResult from TestListeners");
	}
